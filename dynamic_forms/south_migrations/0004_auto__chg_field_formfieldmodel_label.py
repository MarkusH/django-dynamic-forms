...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FormFieldModel.label'
        db.alter_column(u'dynamic_forms_formfieldmodel', 'label', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'FormFieldModel.label'
        db.alter_column(u'dynamic_forms_formfieldmodel', 'label', self.gf('django.db.models.fields.CharField')(max_length=20))
